...
print("Parameters given:", sys.argv, flush = True)

if len(sys.argv) < 4:
    print("Usage: python3 this.py FILE_INDEX_STR P_BEGIN P_END", file = sys.stderr, flush = True)
    exit(255)
...
integrality_dict = {}
file_index_str = sys.argv[1]
for p in primerange(int(sys.argv[2]), int(sys.argv[3])):
    if p % 4 == 1:
